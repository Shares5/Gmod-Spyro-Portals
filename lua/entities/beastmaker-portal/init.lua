...
function ENT:Initialize()
	...
	self.entryportal:SetModel("models/morganicism/spyro/beastmakersportal.mdl")
	...
	self.exitportal:SetModel( "models/morganicism/spyro/beastmakersportal.mdl" )
	...
	self.portals[1]:SetWidth(172)
	self.portals[1]:SetHeight(210)
	local portal1vec = self.entryportal:GetPos()
	portal1vec:Add(Vector(0,0,104))
	self.portals[1]:SetPos(portal1vec)
	local portalangle=self.entryportal:GetAngles()
	portalangle[2] = portalangle[2] + 90
	self.portals[1]:SetAngles(portalangle)
	...
	self.portals[2]:SetWidth(172)
	self.portals[2]:SetHeight(210)
	local portal2vec = self.exitportal:GetPos()
	portal2vec:Add(Vector(0,0,104))
	self.portals[2]:SetPos(portal2vec)
	local portalangle2=self.exitportal:GetAngles()
	portalangle2[2] = portalangle2[2] + 90
	self.portals[2]:SetAngles(portalangle2)
